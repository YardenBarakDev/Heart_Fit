 ...
 * Use the [FragmentLoginAndRegister.newInstance] factory method to
...
class FragmentLoginAndRegister : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentLoginAndRegister.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentLoginAndRegister().apply {
